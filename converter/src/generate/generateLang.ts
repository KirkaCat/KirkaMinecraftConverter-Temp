...
import { _BlockTranslationReference, BlockTranslation } from "../BlockTranslationReference";
import { MinecraftBlock, MinecraftBlockReference } from '../Minecraft/MinecraftBlockReference';
...
export default (function() {
    ...
    const translatedIdPrefixMap = new Map<string, string>();
