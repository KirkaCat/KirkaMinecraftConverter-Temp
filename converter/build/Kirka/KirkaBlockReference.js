...
(function (KirkaBlock) {
    // -- -- --
    let EUICatagory;
    (function (EUICatagory) {
        EUICatagory["AIR"] = "air";
        EUICatagory["CUBE"] = "cube";
        EUICatagory["HALF_BLOCK"] = "HB";
        EUICatagory["PLANTS"] = "plants";
        EUICatagory["DIFFERENT"] = "different";
    })(EUICatagory = KirkaBlock.EUICatagory || (KirkaBlock.EUICatagory = {}));
    let ESlabType;
    (function (ESlabType) {
        ESlabType["BOTTOM"] = "bottom";
        ESlabType["TOP"] = "top";
    })(ESlabType = KirkaBlock.ESlabType || (KirkaBlock.ESlabType = {}));
    let EFacingDirection;
    (function (EFacingDirection) {
        EFacingDirection["NORTH"] = "north";
        EFacingDirection["EAST"] = "east";
